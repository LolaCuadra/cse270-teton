...
class TestSmokeTest():
  ...
  def test_navigatetoAdminPage(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/admin.html")
    self.driver.set_window_size(888, 864)
    elements = self.driver.find_elements(By.ID, "username")
    assert len(elements) > 0
    self.driver.find_element(By.ID, "username").click()
    self.driver.find_element(By.ID, "username").send_keys("lola_cuadra1940")
    self.driver.find_element(By.ID, "password").click()
    self.driver.find_element(By.ID, "password").send_keys("123456789admin")
  ...
  def test_navigatetoDirectoryPage(self):
    ...
    self.driver.find_element(By.ID, "directory-list").click()
    assert self.driver.find_element(By.CSS_SELECTOR, "section:nth-child(5) > p:nth-child(4)").text == "Teton, ID 83451"
    self.driver.set_window_size(1232, 864)
  
  def test_navigatetoHomePage2(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(974, 862)
  ...
  def test_navigatetoJoinPage(self):
